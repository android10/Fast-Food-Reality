...
public class MixState {
	...
	public boolean handleEvent(MixContext ctx, String title, String address, String phonenumber, String onPress) {
		ctx.loadPopup(title, address, phonenumber, onPress);
		return true;
	}
