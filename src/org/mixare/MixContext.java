...
public class MixContext {
	...
	public String getStartUrl() {
		...
		if (intent.getAction() != null && intent.getAction().equals(Intent.ACTION_VIEW)) {
			String currentPositionLatitude = Double.toString(curLoc.getLatitude());
			String currentPositionLongitude = Double.toString(curLoc.getLongitude());			
			
			//android10 modified
			return intent.getData().toString() + "&sll=" + currentPositionLatitude + "," + currentPositionLongitude;
		} 
		else { 
			return ""; 
		}
	...
	public void loadPopup(String title, String address, final String number, final String url){
		//the message to show in the popup
		String msg =  this.mixView.getString(R.string.popup_ar_msg_address) + "\n" + address;
		if (number != "")
			msg += "\n" + this.mixView.getString(R.string.popup_ar_msg_phonenumber) + "\n" + number;
		
    	AlertDialog.Builder builder = new AlertDialog.Builder(this.mixView)
    	.setTitle(title)
		.setMessage(msg)
		.setIcon(R.drawable.about)
		.setPositiveButton(R.string.popup_ar_btn_streetview, new DialogInterface.OnClickListener() {
           public void onClick(DialogInterface dialog, int id) {
                viewStreetView(url);
           }
		})
        .setNeutralButton(R.string.popup_ar_btn_call, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
            	callPlace(number);
            }
        })
       .setNegativeButton(R.string.popup_ar_btn_close, new DialogInterface.OnClickListener() {
           public void onClick(DialogInterface dialog, int id) {
                dialog.cancel();
           }
       });
	...
	public void callPlace(String number){
		this.mixView.startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + number)));
	}
	
	public void viewStreetView(String streetViewUrl){
		this.mixView.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(streetViewUrl)));
	}
