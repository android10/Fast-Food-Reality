...
public class PaintScreen {
	...
	public PaintScreen(Bitmap screenIcon) {
		paint.setTextSize(16);
		paint.setAntiAlias(true);
		paint.setColor(Color.BLUE);
		paint.setStyle(Paint.Style.STROKE);
		bmpIconAR = screenIcon;
	}
	...
	//android10 added
	public void paintIconAR(float x, float y, float radius){
		if (bmpIconAR == null)
			canvas.drawCircle(x, y, radius, paint);
		else
			canvas.drawBitmap(bmpIconAR, x-bmpIconArsize, y-bmpIconArsize, paint);		
	}
